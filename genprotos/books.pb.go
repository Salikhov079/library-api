...
func (x *FilterBook) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FilterBook) ProtoMessage() {}

func (x *FilterBook) ProtoReflect() protoreflect.Message {
	mi := &file_books_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FilterBook.ProtoReflect.Descriptor instead.
func (*FilterBook) Descriptor() ([]byte, []int) {
	return file_books_proto_rawDescGZIP(), []int{3}
}

func (x *FilterBook) GetAuthorId() string {
	if x != nil {
		return x.AuthorId
	}
	return ""
...
func (x *FilterBook) GetGenreId() string {
	if x != nil {
		return x.GenreId
	}
	return ""
...
func (x *FilterBook) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *FilterBook) GetAuthorName() string {
	if x != nil {
		return x.AuthorName
	}
	return ""
...
var file_books_proto_rawDesc = []byte{
	...
	0x73, 0x22, 0x7b, 0x0a, 0x0a, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x42, 0x6f, 0x6f, 0x6b, 0x12,
	...
	0x67, 0x65, 0x6e, 0x72, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07,
	0x67, 0x65, 0x6e, 0x72, 0x65, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65,
	...
	0x28, 0x09, 0x52, 0x0a, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x32, 0xfe,
	0x01, 0x0a, 0x0b, 0x42, 0x6f, 0x6f, 0x6b, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x2d,
	0x0a, 0x0a, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x42, 0x6f, 0x6f, 0x6b, 0x12, 0x0f, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2e, 0x42, 0x6f, 0x6f, 0x6b, 0x52, 0x65, 0x71, 0x1a, 0x0c, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2e, 0x56, 0x6f, 0x69, 0x64, 0x22, 0x00, 0x12, 0x2d, 0x0a,
	0x0a, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x42, 0x6f, 0x6f, 0x6b, 0x12, 0x0f, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x73, 0x2e, 0x42, 0x6f, 0x6f, 0x6b, 0x52, 0x65, 0x73, 0x1a, 0x0c, 0x2e, 0x70,
	...
	0x79, 0x49, 0x64, 0x42, 0x6f, 0x6f, 0x6b, 0x12, 0x0c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73,
	0x2e, 0x42, 0x79, 0x49, 0x64, 0x1a, 0x0f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2e, 0x42,
	0x6f, 0x6f, 0x6b, 0x52, 0x65, 0x73, 0x22, 0x00, 0x12, 0x35, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x41,
	0x6c, 0x6c, 0x42, 0x6f, 0x6f, 0x6b, 0x73, 0x12, 0x12, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73,
	0x2e, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x42, 0x6f, 0x6f, 0x6b, 0x1a, 0x10, 0x2e, 0x70, 0x72,
...
var file_books_proto_goTypes = []interface{}{
	...
	(*FilterBook)(nil), // 3: protos.FilterBook
	(*AuthorRes)(nil),  // 4: protos.AuthorRes
	(*Genre)(nil),      // 5: protos.Genre
	(*ById)(nil),       // 6: protos.ById
	(*Void)(nil),       // 7: protos.Void
}
var file_books_proto_depIdxs = []int32{
	4, // 0: protos.BookRes.author:type_name -> protos.AuthorRes
	5, // 1: protos.BookRes.genre:type_name -> protos.Genre
	...
	6, // 5: protos.BookService.DeleteBook:input_type -> protos.ById
	6, // 6: protos.BookService.GetByIdBook:input_type -> protos.ById
	3, // 7: protos.BookService.GetAllBooks:input_type -> protos.FilterBook
	7, // 8: protos.BookService.CreateBook:output_type -> protos.Void
